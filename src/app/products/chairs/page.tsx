...
import { chairsProducts, chairsSubcategories, filterProducts, ProductRange } from "@/lib/products";
...
export default function ChairsPage() {
    ...
    const filteredProducts = useMemo(() => {
        return filterProducts(chairsProducts, {
            range: selectedRange,
                ...
                <div className="container mx-auto px-4 py-4">
                    <div className="flex items-center justify-between">
                        ...
                        <nav className="hidden md:flex items-center gap-8">
                            ...
                            <Link href="/products/chairs" className="text-sm text-neutral-900 font-medium">Chairs</Link>
            ...
            <main className="pt-20 pb-20">
                ...
                <div className="container mx-auto px-4 py-8">
                    ...
                    <p className="text-neutral-600 max-w-2xl">
                        Find the perfect seating with our collection of chairs featuring stainless steel construction. From ergonomic office chairs to elegant dining sets.
                    </p>
                </div>
