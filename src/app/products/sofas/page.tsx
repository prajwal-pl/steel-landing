...
import { sofasProducts, sofasSubcategories, filterProducts, ProductRange } from "@/lib/products";
...
export default function SofasPage() {
    ...
    const filteredProducts = useMemo(() => {
        return filterProducts(sofasProducts, {
            range: selectedRange,
                ...
                <div className="container mx-auto px-4 py-4">
                    <div className="flex items-center justify-between">
                        ...
                        <nav className="hidden md:flex items-center gap-8">
                            <Link href="/products/sofas" className="text-sm text-neutral-900 font-medium">Sofas</Link>
