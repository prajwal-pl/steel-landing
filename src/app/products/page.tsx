...
import { allProducts, categories, filterProducts, ProductRange, ProductCategory } from "@/lib/products";
...
export default function ProductsPage() {
    ...
    const hasActiveFilters = selectedRange || selectedCategory;
                ...
                <div className="container mx-auto px-4 py-4">
                    <div className="flex items-center justify-between">
                        ...
                        <nav className="hidden md:flex items-center gap-8">
                            ...
                            <Link href="/products" className="text-sm text-neutral-900 font-medium">All Products</Link>
            ...
            <main className="pt-20 pb-20">
                ...
                <div className="container mx-auto px-4 py-8">
                    ...
                    <p className="text-neutral-600 max-w-2xl">
                        Browse our complete collection of premium stainless steel furniture. From sofas to beds, tables to chairs, find the perfect pieces for your home.
                    </p>
                </div>
                ...
                <div className="container mx-auto px-4 mb-12">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        {categories.map((cat) => (
                            <button
                                key={cat.slug}
                                onClick={() => setSelectedCategory(selectedCategory === cat.name as ProductCategory ? null : cat.name as ProductCategory)}
                                className={`group relative aspect-[4/3] overflow-hidden rounded-lg ${
                                    selectedCategory === cat.name ? "ring-2 ring-neutral-900" : ""
                                }`}
                            >
                                <Image
                                    src={cat.image}
