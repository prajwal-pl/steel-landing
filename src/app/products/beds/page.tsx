...
import { bedsProducts, bedsSubcategories, filterProducts, ProductRange } from "@/lib/products";
...
export default function BedsPage() {
    ...
    const filteredProducts = useMemo(() => {
        return filterProducts(bedsProducts, {
            range: selectedRange,
                ...
                <div className="container mx-auto px-4 py-4">
                    <div className="flex items-center justify-between">
                        ...
                        <nav className="hidden md:flex items-center gap-8">
                            ...
                            <Link href="/products/beds" className="text-sm text-neutral-900 font-medium">Beds</Link>
            ...
            <main className="pt-20 pb-20">
                ...
                <div className="container mx-auto px-4 py-8">
                    ...
                    <p className="text-neutral-600 max-w-2xl">
                        Experience unparalleled comfort with our premium beds featuring stainless steel frames. From space-saving singles to luxurious king-size options with smart storage.
                    </p>
                </div>
